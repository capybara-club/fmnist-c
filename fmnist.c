...
FMNIST_C_PUBLIC_DEF
const char*
fmnist_c_result_to_string(
	FmnistCResult result
) {
	switch(result) {
		case FMNIST_C_RESULT_SUCCESS:           return "FMNIST_C_RESULT_SUCCESS";
		case FMNIST_C_ERROR_CANT_OPEN_FILE:		return "FMNIST_C_ERROR_CANT_OPEN_FILE";
		case FMNIST_C_ERROR_CANT_FSTAT_FILE:	return "FMNIST_C_ERROR_CANT_FSTAT_FILE";
		case FMNIST_C_ERROR_CANT_MMAP_FILE:     return "FMNIST_C_ERROR_CANT_MMAP_FILE";
		case FMNIST_C_ERROR_CANT_MUNMAP_FILE:   return "FMNIST_C_ERROR_CANT_MUNMAP_FILE";
		case FMNIST_C_ERROR_INSUFFICIENT_DEST:	return "FMNIST_C_ERROR_INSUFFICIENT_DEST";
		case FMNIST_C_ERROR_DIM_MISMATCH:	    return "FMNIST_C_ERROR_DIM_MISMATCH";
		case FMNIST_C_ERROR_INVALID_DATA: 	    return "FMNIST_C_ERROR_INVALID_DATA";
		case FMNIST_C_RESULT_NUM_ELEMS: break;
	}
	return "FMNIST_C_ERROR_INVALID_RESULT_ENUM";
}
